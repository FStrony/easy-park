...
public class EstacionamentoBean implements Serializable {
	...
	private Pais pais;
	// 0 nÃ£o tem seguro 1 tem seguro
	...
	public void addTelefone() {
		...
		if (telefone != null) {
			...
			System.out.println("Telefones estï¿½o nullo");
		}
	...
	/**
	 * O objetivo deste metodo e validar se os campos de valor da diaria, mensal ou semestral estão na forma monetaria
